      ...
      >
        ...
        {documentsDrawerState !== 'closed' && (
          <>
            ...
            <div className={`absolute top-0 left-0 bottom-0 bg-white z-40 w-4/5 overflow-hidden shadow-xl ${
              documentsDrawerState === 'closing' ? 'drawer-slide-out' : 'drawer-slide-in'
            }`}>
        ...
        {quizDrawerState !== 'closed' && (
          <>
            ...
            />
            <div className={`absolute bottom-0 left-0 right-0 bg-white rounded-t-xl z-40 max-h-[80vh] overflow-hidden ${
              quizDrawerState === 'closing' ? 'drawer-slide-down' : 'drawer-slide-up'
            }`}>
              <div className="flex items-center justify-between p-4 border-b border-gray-200">
                <h2 className="text-lg font-semibold text-gray-900">
                  Quiz Tools
        ...
        {moreDrawerState !== 'closed' && (
          <>
            ...
            />
            <div className={`absolute bottom-0 left-0 right-0 bg-white rounded-t-xl z-40 max-h-[80vh] overflow-hidden ${
              moreDrawerState === 'closing' ? 'drawer-slide-down' : 'drawer-slide-up'
            }`}>
              <div className="flex items-center justify-between p-4 border-b border-gray-200">
